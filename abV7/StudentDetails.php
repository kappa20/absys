    ...
    <main class="mt-5 pt-3">
        ...
        <script>
            ...
            <table class="justified" border="1">`
                ...
                var headJ = `
            <tr><th class="table_head" colspan=\"4\">Table des absences justifiées</th></tr>
            ...
            `
                var headNJ = `
            <tr><th class="table_head" colspan=\"4\">Table des absences Non justifiées</th></tr>
        ...
        if (isset($_GET['id'])) {
            ...
            echo "
                <script>
                    window.onload = GetInfo('./dist/getData.php?id=','$id')
                </script>";
        }
