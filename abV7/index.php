          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <table id="table_stagiaire" class="table table-striped data-table" style="width: 100%">
                  <thead>
                    <tr>
                      <th>Nom</th>
                      <th>Prenom</th>
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) {
                      ...
                      $hint .= "
                            <tr class=\"rowtable\" onclick=\"window.location.replace('StudentDetails.php?id=$id_st')\">
                                <td>$nom</td>
                                <td>$prenom</td>
                                <td>$heure_absence</td>
                                <td>$filier</td>
