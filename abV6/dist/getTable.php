<?php require_once "./includes/dbh.inc.php";
        ...
        $sql = "";
            ...
            E.id_st = S.id_st AND etat_justif = 'J' AND S.id_st = 4 ;";
            

            $sql .= "SELECT etat_justif, nom_st, prenom_st, date_abs, heure_debut_abs, heure_fin_abs from
            etat_absence as E , stagiaire as S where 
            E.id_st = S.id_st AND etat_justif = 'NYJ' AND S.id_st = 4 ;";

            $sql .= "SELECT etat_justif, nom_st, prenom_st, date_abs, heure_debut_abs, heure_fin_abs from
            etat_absence as E , stagiaire as S where 
            E.id_st = S.id_st AND etat_justif = 'NJ' AND S.id_st = 4 ;";
